...
export default class implements IAppointmentRepository {
    ...
    constructor() {
        ...
        const clientOne = Client.create('1', 'Giorge', 'last','11', '999999999', 'giorgeabdala@gmail.com').unwrap();
        const clientTwo  = Client.create('2', 'Jo','last', '11', '999999999', 'giorgeabdala@gmail.com').unwrap();
        const clientThree = Client.create('3', "bruna",'last', '11', '999999999', 'giorgeabdala@gmail.com').unwrap();

        const professionalOne = Professional.create('1', 'Mara', 'last','11', '999999999', 'joao@gmail.com', 'j2ialadmckmcdne2i7bmfvsovs@group.calendar.google.com').unwrap();
        const professionalTwo =    Professional.create('2', 'Giorge', 'last', '11', '999999999', 'maria@gmail.com').unwrap();
        const professionalThree =     Professional.create('3', 'José','last', '11', '999999999', 'jose@gmail.com').unwrap();
